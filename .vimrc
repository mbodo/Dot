...
" % % Automaticaly expand to the path of active buffer
...
inoremap <leader><Down> <Esc>:m .+1<CR>
inoremap <leader><Up> <Esc>:m .-2<CR>
vnoremap <leader><Down> :m '>+1<CR>gv
vnoremap <leader><Up> :m '<-2<CR>gv
